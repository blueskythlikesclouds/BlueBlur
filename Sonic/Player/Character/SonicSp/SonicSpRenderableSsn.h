...
namespace Sonic::Player
{
    ...
    public:
        ...
        boost::anonymous_shared_ptr m_Field170;
        boost::anonymous_shared_ptr m_Field178;
    ...
    BB_ASSERT_OFFSETOF(CSonicSpRenderableSsn, m_Field170, 0x170);
    BB_ASSERT_OFFSETOF(CSonicSpRenderableSsn, m_Field178, 0x178);
